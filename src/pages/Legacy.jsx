...
export default function Legacy() {
  ...
  return (
    <div className="pt-28 pb-24 px-3 sm:px-6 md:px-12 dark:bg-gray-900 bg-[#FFFDF9] transition-colors duration-300 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 p-6 md:p-12 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl overflow-hidden transition-colors duration-300 mb-4"
        >
          ...
          <div className="flex flex-col md:flex-row items-start gap-10 md:gap-12">
            ...
            >
              ...
              <ul className="space-y-6 pt-2">
                <motion.li
                  initial={{ opacity: 0, x: -24, rotateX: 10 }}
            ...
            <div className="w-full md:w-1/2 grid grid-cols-2 gap-4">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ scale: 1.05, rotateX: -4, rotateY: 6, boxShadow: '0 0 22px rgba(234,179,8,0.45), 0 8px 24px rgba(0,0,0,0.15)', transition: { duration: 0.25 } }}
                  style={{ transformPerspective: 700 }}
