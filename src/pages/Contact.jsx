...
export default function Contact() {
  return (
    <section className="pt-28 pb-24 px-4 md:px-12 bg-white dark:bg-gray-900 transition-colors duration-300 min-h-screen flex items-start md:items-center">
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="bg-gray-900 dark:bg-black shadow-2xl overflow-hidden flex flex-col md:flex-row w-full transition-colors duration-300 rounded-none border border-gray-800">
          ...
          <div className="md:w-3/5 p-8 md:p-10 bg-[#FFFDF9] dark:bg-gray-950 transition-colors duration-300">
